...
let OAuthController = class OAuthController {
    ...
    async authorizeRedirect(provider, projectId, clientId, clientSecret, scopes, redirectUri, returnUrl, res) {
    ...
    async handleCallback(provider, query, res) {
        ...
        if (result.returnUrl) {
            ...
            res.redirect(`${result.returnUrl}${separator}credentialId=${result.credentialId}&success=true`);
        }
        else {
            res.json({
                success: true,
...
], OAuthController.prototype, "getProviders", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], OAuthController.prototype, "authorizeRedirect", null);
__decorate([
