...
export declare class ResourcesService {
    ...
    createVersion(projectId: string, resourceId: string, version: string, changelog?: string): Promise<ResourceVersion>;
    ...
    generatePrisma(projectId: string, resourceId: string): Promise<{
        prisma: string;
    }>;
    generateValidation(projectId: string, resourceId: string, operation: 'create' | 'update' | 'response'): Promise<{
        dto: string;
    }>;
