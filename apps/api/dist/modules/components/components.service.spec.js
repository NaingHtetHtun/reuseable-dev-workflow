...
describe('ComponentsService', () => {
    ...
    describe('findAll', () => {
        ...
        it('should filter by search', async () => {
            ...
            expect(prisma.component.findMany).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('createVersion', () => {
        ...
        it('should throw BadRequestException for invalid version', async () => {
            await expect(service.createVersion('project-1', 'comp-1', 'invalid')).rejects.toThrow(common_1.BadRequestException);
        });
        it('should throw ConflictException for duplicate version', async () => {
            ...
            await expect(service.createVersion('project-1', 'comp-1', '1.0.0')).rejects.toThrow(common_1.ConflictException);
        });
    });
    ...
    describe('clone', () => {
        ...
        it('should throw ConflictException for duplicate name', async () => {
            prisma.component.findFirst
                .mockResolvedValueOnce(mockComponent)
                .mockResolvedValueOnce(mockComponent);
            await expect(service.clone('project-1', 'comp-1', 'existing-name')).rejects.toThrow(common_1.ConflictException);
        });
    });
});
