...
describe('ProjectsController (Integration)', () => {
    ...
    describe('POST /api/v1/projects', () => {
        ...
        it('should return 400 for empty name', async () => {
            await (0, supertest_1.default)(app.getHttpServer()).post('/api/v1/projects').send({ name: '' }).expect(400);
        });
    });
    describe('GET /api/v1/projects', () => {
        it('should return paginated projects', async () => {
            ...
            const response = await (0, supertest_1.default)(app.getHttpServer()).get('/api/v1/projects').expect(200);
        ...
        it('should pass search parameter to service', async () => {
            ...
            await (0, supertest_1.default)(app.getHttpServer()).get('/api/v1/projects?search=test').expect(200);
            expect(mockProjectsService.findAll).toHaveBeenCalledWith(expect.objectContaining({ page: 1, limit: 20 }), 'test');
        });
    });
    describe('GET /api/v1/projects/:id', () => {
        ...
        it('should return 404 for missing project', async () => {
            ...
            await (0, supertest_1.default)(app.getHttpServer()).get('/api/v1/projects/nonexistent').expect(404);
        });
    });
    ...
    describe('DELETE /api/v1/projects/:id', () => {
        it('should delete a project and return 204', async () => {
            ...
            await (0, supertest_1.default)(app.getHttpServer()).delete('/api/v1/projects/test-uuid-123').expect(204);
        });
        it('should return 404 for missing project', async () => {
            const { NotFoundException } = await Promise.resolve().then(() => __importStar(require('@nestjs/common')));
            mockProjectsService.remove.mockRejectedValueOnce(new NotFoundException('Project not found'));
            await (0, supertest_1.default)(app.getHttpServer()).delete('/api/v1/projects/nonexistent').expect(404);
        });
    });
});
