...
describe('WorkflowsService', () => {
    ...
    describe('create', () => {
        ...
        it('should reject invalid definition', async () => {
            await expect(service.create('project-123', {
                name: 'Bad Workflow',
                definition: { nodes: [], edges: [] },
            })).rejects.toThrow(common_1.BadRequestException);
        });
        it('should throw if project not found', async () => {
            mockProjectsService.findOne.mockRejectedValueOnce(new common_1.NotFoundException('Project not found'));
            await expect(service.create('nonexistent', {
                name: 'Test',
                definition: mockWorkflow.definition,
    ...
    describe('findAll', () => {
        ...
        it('should filter by status', async () => {
            ...
            expect(mockPrismaService.workflow.findMany).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('findOne', () => {
        ...
        it('should throw NotFoundException for missing workflow', async () => {
            ...
            await expect(service.findOne('project-123', 'nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    describe('update', () => {
...
//# sourceMappingURL=workflows.service.spec.js.map