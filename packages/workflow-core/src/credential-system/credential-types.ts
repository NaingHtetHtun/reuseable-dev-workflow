  ...
  for (const [key, value] of Object.entries(data)) {
    ...
    if (field && value !== undefined && value !== null) {
      if (!matchesType(value, field.type)) {
        errors.push(
          `Field "${field.displayName}" expected type "${field.type}" but got "${typeof value}"`,
        );
      }
    }
  }
...
export const bearerTokenCredentialType: CredentialTypeDefinition = {
  type: 'bearer-token',
...
export const googleOAuth2CredentialType: CredentialTypeDefinition = {
  type: 'google-oauth2',
...
export const githubTokenCredentialType: CredentialTypeDefinition = {
  type: 'github-token',
...
export const smtpCredentialType: CredentialTypeDefinition = {
  type: 'smtp',
