...
export declare class OAuthTokenManager {
    ...
    constructor(provider: OAuthProvider, credentialResolver: (id: string) => Promise<Record<string, unknown>>, credentialUpdater: (id: string, data: Record<string, unknown>, metadata: Record<string, unknown>) => Promise<void>, logger?: Logger);
    /**
     ...
     */
    getValidAccessToken(credentialId: string, clientId: string, clientSecret: string, credentialMetadata: Record<string, unknown>): Promise<string>;
    /**
