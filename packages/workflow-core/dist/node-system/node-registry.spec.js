...
describe('NodeRegistry', () => {
    ...
    describe('register', () => {
        ...
        it('should reject duplicate registration', () => {
            registry.register(mockDefinition, new MockHandler('test-node'));
            expect(() => registry.register(mockDefinition, new MockHandler('test-node'))).toThrow('already registered');
        });
        it('should reject mismatched types', () => {
            expect(() => registry.register(mockDefinition, new MockHandler('wrong-type'))).toThrow('does not match');
        });
    });
